...
(function () {
  ...
  // сам.
  // Дата — из сцены письма: понедельник, 13:00. Держать её здесь литералом приходится
  // потому, что это лист ответа, а не реплика; при смене дня в сценах поправить и тут.
  M.letter.answerHtml = function (m, ctx) {
    var nm = (ctx.pname && ctx.pname()) || '';
    var head = '<p><b>От:</b> ' + (nm ? ctx.esc(nm) : 'вы') +
      '<br /><b>Кому:</b> Кирилл Агеев' +
      '<br /><b>Дата:</b> понедельник, 9 февраля 2026, 13:00' +
