    ...
    render: function (host, m, ctx) {
      var draw = function () {
        ...
        var col = function (title, arr, d) {
          ...
          // складывать нечего.
          // ⚠ Точка ПЕРЕД суммой обязательна: без неё счёт карточек и число людей
          // стояли подряд через пробел — «Берём · 2 460 чел.» читалось как две с
          // половиной тысячи человек вместо двух заявок на 460.
