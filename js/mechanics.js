...
(function () {
  ...
  M.variants = {
    ...
    render: function (host, m, ctx) {
      ...
      var draw = function () {
        ...
        var h = head(COPY.variants.section, '<span class="mx-count mx-tally">' + m.rays.length + '</span>');
  ...
  M.futures = {
    ...
    render: function (host, m, ctx) {
      var draw = function () {
        var h = head(COPY.futures.section, '<span class="mx-count mx-tally">' + m.cards.length + '</span>');
