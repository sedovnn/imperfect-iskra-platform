  ...
  M.variants = {
    ...
    render: function (host, m, ctx) {
      ...
      var drawMain = function () {
        ...
        // Заход виден; вопросы (act.probeAsk) уходят в ОБЩУЮ свёртку шага, которую рисует
        // движок над рабочей областью, — второй свёрнутый блок здесь был бы новым узором,
        // какого в дне нет нигде (замечание владельца 28.08).
