...
(function () {
  ...
  // Кроме тегов — классы блоков, чей текст лежит не в <p>: реплики раундов и
  // страница «Как проходить» (там пункты в span внутри flex-строки, и без них
  // тире вставало в начало строки на узком экране).
  var SELECTORS = [
