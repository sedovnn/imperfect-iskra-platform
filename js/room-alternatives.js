...
(function () {
  ...
  function initWorkspace() {
    ...
    function buildQ1Block() {
      ...
      block.innerHTML =
        '<p class="s2-ageev"><b>Олег Брагин</b> скользит взглядом по вашему бейджу: «Консультант, значит. Я тут двадцать лет — со времён когда поиск ещё на коленке собирали. И знаете, вы все приходите к одному и тому же: один нормальный ход, остальное красивые слова. Если видите тут другой заход — давайте, попробуйте убедить меня.»</p>' +
    ...
    function buildQ2Block() {
      ...
      block.innerHTML =
        ...
        '<p class="s2-ageev"><b>Брагин</b> отхлёбывает кофе: «А где по дороге сомневались? Что ещё крутили в голове и почему отбросили в итоге?»</p>' +
