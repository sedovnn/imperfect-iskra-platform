...
// комнат (МК — «Образ будущего», ГА — «Другие пути», ПП — «Путь назад») + финализация
// стратегии. Порядок посещения свободный, полнота не гейтится — единственное
// реальное ограничение — общее время участника на раунд 1 (~2 часа), поэтому
// финализировать можно и не зайдя во все комнаты: непосещённая комната просто
// не даёт сигнала по своей способности, это не штраф и не блокер.
  ...
  var ROOMS = [
    {
      ...
      teaser: 'Пятнадцать минут с членом правления — картина рынка на разных горизонтах.',
    ...
    },
    {
      key: 'alternatives',
      title: 'Другие пути',
      teaser: 'Случайная встреча по пути — стоит ли искать третий вариант, а не только «Крепость» или «Вторая кривая».',
    ...
    },
    {
      key: 'path',
      title: 'Путь назад',
      teaser: 'Из образа будущего — обратно к настоящему: вехи, зависимости, ограничения.',
      href: 'room-path.html',
