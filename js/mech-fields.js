...
(function () {
  ...
  var FORM_ONLY = {
    ...
    'Основное решение': 'на экране это отметка на карточке варианта, а не поле',
  ...
  window.imp.mechFields = {
    ...
    variants: {
      ...
      toState: function (o) {
        ...
        }), picked: null, mainIx: null, mainWhy: '' };
      },
      ...
      formMain: { 'Основное решение': 'номер варианта из списка выше',
                  [C.variants.mainWhy.label]: C.variants.mainWhy.ph },
      mainToState: function (o) {
        var n = parseInt(String(o['Основное решение'] || o['основное решение'] || '').replace(/\D/g, ''), 10);
        return { picked: true,
                 mainIx: isNaN(n) ? null : n - 1,
                 mainWhy: String(o[C.variants.mainWhy.label] || o['почему именно оно основное'] || '') };
      }
    },
