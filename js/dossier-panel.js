// i(m)perfect — «Мои ответы» как выезжающий справа ящик поверх текущего экрана.
// Кнопка живёт в шапке (её создаёт case-ref.js) и есть на ВСЕХ рабочих экранах,
// включая раунд 1: одинаковая функция — одинаковая механика на каждой странице.
// Пустое досье показывает заглушку «Пока ничего не сохранено…».
//
