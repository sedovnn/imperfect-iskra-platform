...
(function () {
  ...
  function subst(text) {
    ...
    if (t.indexOf('{over}') >= 0) {
      ...
      var parts = [];
      if (ts.people > LIM.people) parts.push(String(ts.people) + ' человек — при бюджете в ' + String(LIM.people));
      ...
      if (!parts.length) parts.push(String(ts.people) + ' человек — при бюджете в ' + String(LIM.people));
