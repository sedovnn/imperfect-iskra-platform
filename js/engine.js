...
(function () {
  ...
  function render() {
    ...
    for (var i = 0; i < route.length; i++) {
      ...
      // в кабинете Агеева их к концу пять. Их содержимое уже зафиксировано и лежит
      // отдельными листами во вкладке «Мои ответы», которая на переходе между встречами
      // сама на них и открывается. Держать то же самое ещё и над рабочей областью значит
      // показывать один ответ в двух местах и отодвигать живой вопрос вниз.
      ...
      // Принятая цена: в «Прожекторе» свёртки нет сознательно (одна беседа на четыре
      // голоса), и на вопросе Олега разговор с Дарьей уходит с экрана — перечитать его
      // можно во вкладке.
      if (past) { pending = []; continue; }
