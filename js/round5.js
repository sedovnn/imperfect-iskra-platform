  ...
  function initWorkspace() {
    ...
    function buildQ1Block() {
      ...
      block.innerHTML =
        ...
        them('Брагин', { act: 'поворачивается к вам', speech: '«Вот и рассудите: кто из нас прав — получится у них или нет? И если бы вы у них за это отвечали — что бы делали?»' }) +
    ...
    function buildQ2Block() {
      ...
      block.innerHTML =
        ...
        them('Даша', { act: 'ставит стакан', speech: '«А что ещё у них есть в руках? И почему вы бы выбрали именно то, что сказали?»' }) +
