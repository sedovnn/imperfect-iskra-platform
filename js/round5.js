  ...
  function initWorkspace() {
    ...
    function buildQ1Block() {
      ...
      block.innerHTML =
        ...
        them('Олег Брагин', { act: 'фыркает', speech: '«Да ничего они не построят. Наберут звёзд и утонут».' }) +
    ...
    function buildQ3Block() {
      ...
      block.innerHTML =
        ...
        them('Олег Брагин', { act: 'провожает её взглядом', speech: '«Тут все друг у друга подсматривают, кофейня такая. Только вы про них ничего толком не знаете — ни цифр, ни планов. Откуда тогда всё это? Из головы или видели где-то?»' }) +
