  ...
  function initWorkspace() {
    ...
    function buildQ2Block() {
      ...
      block.innerHTML =
        ...
        '<p class="s2-ageev"><b>Брагин</b> делает глоток: «А сами-то где колебались, пока за них думали? Что перебрали и отбросили — и почему?».</p>' +
    ...
    function buildQ3Block() {
      ...
      block.innerHTML =
        ...
        '<p class="s2-ageev"><b>Брагин</b> провожает её взглядом: «Тут все друг у друга подсматривают, кофейня такая. Вы же про них толком ничего не знаете — ни цифр, ни планов. Откуда тогда ваш ход? Из головы, из жизни?»</p>' +
