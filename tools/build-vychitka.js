...
// ── БЛОКИ ────────────────────────────────────────────────────────────────────
const WHEN = {
  // Шаг про цену выбора с 12.08 БЕЗУСЛОВНЫЙ — условны только числа про перебор, они
  // звучат отдельной репликой. Пометка осталась для неё.
  overspend: 'условная реплика: числа звучат только если участник вышел за 500 человек или 22 млрд',
